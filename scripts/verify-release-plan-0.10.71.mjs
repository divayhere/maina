...
assert.match(source('android/app/build.gradle'), /versionCode 97/);
assert.match(source('android/app/build.gradle'), /versionName "0\.10\.71"/);
...
assert.match(source('src/app/record.tsx'), /status = await waitForNativeSaveResolution/);
