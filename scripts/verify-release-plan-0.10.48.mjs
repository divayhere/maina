...
assert.match(source('ios/Maina/Info.plist'), /<key>CFBundleShortVersionString<\/key>\s*<string>0\.10\.48<\/string>/);
assert.match(source('ios/Maina/Info.plist'), /<key>CFBundleVersion<\/key>\s*<string>30<\/string>/);
...
assert.match(source('scripts/build-ios-release-candidate.sh'), /Maina-0\.10\.48-30\.app\.zip/);
assert.match(source('scripts/build-ios-release-candidate.sh'), /Maina-0\.10\.48-30\.app\.dSYM\.zip/);
