...
OUTPUT_DIR="${MAINA_RELEASE_OUTPUT_DIR:-$MAINA_RELEASE_OUTPUT_ROOT/android/Maina-0.10.48-74-candidate}"
...
HELD_APK="$OUTPUT_DIR/Maina-0.10.48-74.apk"
cp "$APK" "$HELD_APK"
node scripts/inspect-exact-artifact.mjs android release/m3-m4-0.10.48-candidate-plan.json "$HELD_APK" \
