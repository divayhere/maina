...
OUTPUT_DIR="${MAINA_RELEASE_OUTPUT_DIR:-$MAINA_RELEASE_OUTPUT_ROOT/android/Maina-0.10.65-91-candidate}"
...
HELD_APK="$OUTPUT_DIR/Maina-0.10.65-91.apk"
cp "$APK" "$HELD_APK"
node scripts/inspect-exact-artifact.mjs android release/m3-m4-0.10.65-candidate-plan.json "$HELD_APK" \
