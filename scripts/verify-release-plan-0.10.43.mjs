...
assert.match(source('ios/Maina/Info.plist'), /<key>CFBundleShortVersionString<\/key>\s*<string>0\.10\.43<\/string>/);
assert.match(source('ios/Maina/Info.plist'), /<key>CFBundleVersion<\/key>\s*<string>25<\/string>/);
...
assert.match(source('scripts/build-ios-release-candidate.sh'), /Maina-0\.10\.43-25\.app\.zip/);
