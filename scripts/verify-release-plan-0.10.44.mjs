...
assert.match(source('ios/Maina/Info.plist'), /<key>CFBundleShortVersionString<\/key>\s*<string>0\.10\.44<\/string>/);
assert.match(source('ios/Maina/Info.plist'), /<key>CFBundleVersion<\/key>\s*<string>26<\/string>/);
...
assert.match(source('scripts/build-ios-release-candidate.sh'), /Maina-0\.10\.44-26\.app\.zip/);
assert.match(source('scripts/build-ios-release-candidate.sh'), /Maina-0\.10\.44-26\.app\.dSYM\.zip/);
