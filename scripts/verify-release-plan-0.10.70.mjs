...
assert.match(source('android/app/build.gradle'), /versionCode 96/);
assert.match(source('android/app/build.gradle'), /versionName "0\.10\.70"/);
...
assert.match(source('src/data/meetings.ts'), /CAPTURE_START_DATABASE_DEADLINE_MS = 15_000/);
assert.match(source('src/data/db.ts'), /checkpointBackgroundTransaction/);
assert.match(source('src/data/db.ts'), /isDatabaseRecordingAdmissionPending/);
