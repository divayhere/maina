...
assert.match(source('ios/Maina/Info.plist'), /<key>CFBundleShortVersionString<\/key>\s*<string>0\.10\.46<\/string>/);
assert.match(source('ios/Maina/Info.plist'), /<key>CFBundleVersion<\/key>\s*<string>28<\/string>/);
...
assert.match(source('scripts/build-ios-release-candidate.sh'), /Maina-0\.10\.46-28\.app\.zip/);
assert.match(source('scripts/build-ios-release-candidate.sh'), /Maina-0\.10\.46-28\.app\.dSYM\.zip/);
