...
MAINA_GRADLE_HOME="${MAINA_GRADLE_HOME:-/Users/divay/.cache/maina-build-tools/gradle/gradle-9.3.1}"
...
export MAINA_BUILD_ROOT MAINA_GRADLE_HOME MAINA_ADB_SERIAL MAINA_DEVICE_SERIAL MAINA_ANDROID_ABI
